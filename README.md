# Fork Info
LabWorks's Fork of the Marrow Extended SDK for personal development and use.
Can act as a temporary Extended SDK until Swipez updates his.
This SDK may contain some scripts that are no longer in game, as I have not gone back and actually checked most of what changed. Only main things updated were locations of VoidLogic and a few other things.
...
```
https://github.com/volx64/MarrowSDKExt-Labworks.git#patch6
```
